...
$fp_boxes = array (
	'Team Member Information' => array (
			array( 'title', 'Team Member Working Title, i.e "Designer"' , 'textfield'),
			array( 'twitter', 'Team Member Twitter Url (optional, but good to have), i.e "http://twitter.com/yourhandle"' , 'textfield'),
			array( 'facebook', 'Team Member Facebook Url (optional, but good to have), i.e "http://facebook.com/yourname"' , 'textfield'),
			array( 'linkedin', 'Team Member LinkedIn Public Url (optional, but good to have), i.e "http://www.linkedin.com/in/yourname"' , 'textfield'),
		),
);
	...
	// Adds a custom section to the –advanced” Post and Page edit screens
		...
		foreach ( array_keys( $fp_boxes ) as $box_name ) {
			add_meta_box( $box_name, __( $box_name, 'fp' ), 'fp_post_custom_box', 'team', 'normal', 'high' );
			}
		}
		}

		...
		<table cellspacing="0" align="center" style="font-size: 12px; line-height: 20px; font-family: Arial, sans-serif; color: #666666;" width="540" cellpadding="0">
			...
			<tr>
				...
				<td valign="top" style="font-size: 12px; line-height: 20px; font-family: Arial, sans-serif; color: #666666;" width="166">
					...
					<a href="*|RSSITEM:URL|*" style="color: #2A5DB0;"><img src="*|RSSITEM:ENCLOSURE_URL|*" alt="<?php the_title(); ?>" width="166" height="220" alt=""></a>
				...
				<td valign="top" style="font-size: 12px; line-height: 20px; font-family: Arial, sans-serif; color: #666666;" width="352">
				
					<h3 style="font-size: 16px; font-family: Arial, sans-serif; color: #000000;"><span style="color: #000000;">*|RSSITEM:TITLE|*</span></h3>

					<p style="font-size: 12px; line-height: 20px; font-family: Arial, sans-serif; color: #666666;">*|RSSITEM:CONTENT|*</p>

					<p style="font-size: 12px; line-height: 20px; font-family: Arial, sans-serif; color: #666666;"><a href="*|RSSITEM:URL|*" style="color: #2A5DB0;"><?php _e( 'Continue Reading', 'cebolang' ); ?></a></p>
